...
Display( )
{
	...
	/*********horse1 & pillar1*********/
	glPushMatrix();
	glTranslated(2.5 * sin(2 * M_PI * Time), 2.5 * cos(2 * M_PI * Time), 0.);
	glCallList(pillar1);
	glRotated(360. * Time * 2, 0., 0., -1.);
	glTranslated( 0., 0., 0.3 * cos(2 * M_PI * Time));
	glCallList(horse1);
	...
	/*********horse2 & pillar2*********/
	glPushMatrix();
	glTranslated(2.5 * sin(2 * M_PI * Time + 36), 2.5 * cos(2 * M_PI * Time + 36), 0.);
	glCallList(pillar2);
	glRotated(-360. * Time * 2, 0., 0., -1.);
	glTranslated(0., 0., 0.3 * sin(2 * M_PI * Time));
	glCallList(horse2);
	glScaled(0.1f, 0.1f, 0.1f);
	glPopMatrix();
	...
	/*********horse3 & pillar3*********/
	glPushMatrix();
	glTranslated(2.5 * sin(2 * M_PI * Time + 72), 2.5 * cos(2 * M_PI * Time + 72), 0.);
	glCallList(pillar3);
	glRotated(360. * Time * 2, 0., 0., -1.);
	glTranslated(0., 0., 0.3 * cos(2 * M_PI * Time));
	glCallList(horse3);
	...
	/*********horse4 & pillar4*********/
	glPushMatrix();
	glTranslated(2.5 * sin(2 * M_PI * Time + 108), 2.5 * cos(2 * M_PI * Time + 108), 0.);
	glCallList(pillar4);
	glRotated(-360. * Time * 2, 0., 0., -1.);
	glTranslated(0., 0., 0.3 * sin(2 * M_PI * Time));
	glCallList(horse4);
...
InitLists( )
{
	...
	/*********the things animating*******/
	//draw the wall
	Wall = glGenLists(2);
	glNewList(Wall, GL_COMPILE);
	glPushMatrix();
	glColor3f(0.5f, 0.35f, 1.);
	GLUquadricObj* w = gluNewQuadric();
	gluCylinder(w, 10.0f, 10.0f, 10.0f, 36, 5);
	glEndList();
	glPopMatrix();
	//grass ground
	GDown = glGenLists(2);
	glNewList(GDown, GL_COMPILE);
	glPushMatrix();
	glBegin(GL_TRIANGLE_FAN);
	glColor3f(0., 1., 0.);
	for (int i = 0; i < 100; i++) {
		glVertex3f(10.0f * cos(ang), 10.0f * sin(ang), 0.);
		ang += dang;
	}
	glEnd();
	glEndList();
	...
	//white cylinder
	GMid = glGenLists(2);
	glNewList(GMid, GL_COMPILE);
	glPushMatrix();
	glColor3f(1., 1., 1.);
	GLUquadricObj* object = gluNewQuadric();
	gluCylinder(object, 3.0f, 3.0f, 0.3f, 36, 5);
	glEndList();
	glPopMatrix();

	//purple circle
	GTop = glGenLists(2);
	glNewList(GTop, GL_COMPILE);
	glPushMatrix();
	glTranslatef(0., 0., 0.3f);
	glEnable(GL_TEXTURE_2D);
	unsigned char* ground;
	ground = BmpToTexture("ground.bmp", &Tex_width, &Tex_height);
	...
	glTexImage2D(GL_TEXTURE_2D, 0, 3, Tex_width, Tex_height, 0, GL_RGB, GL_UNSIGNED_BYTE, ground);
	
	glBegin(GL_TRIANGLE_FAN);
	for (int i = 0; i < 100; i++) {
		glVertex3f(r1 * cos(ang), r1 * sin(ang), 0.);
		ang += dang;
	}
	glEnd();
	...
	//pillar1 & horse1 red
	pillar1 = glGenLists(2);
	glNewList(pillar1, GL_COMPILE);
	glPushMatrix();
	glColor3f(0.5f, 0.35f, 0.05f);
	GLUquadricObj* obj1 = gluNewQuadric();
	gluCylinder(obj1, 0.05f, 0.05f, r2, 36, 5);
	glEndList();
	glPopMatrix();
	glPushMatrix();
	horse1 = glGenLists(3);
	glNewList(horse1, GL_COMPILE);
	glTranslated(0, 0, 1.5f);
	glColor3f(1.,0.,0.);
	glScaled(0.01f, 0.01f, 0.01f);
	unsigned char* Texture1;
	Texture1 = BmpToTexture("cow.bmp", &Tex_width, &Tex_height);
	glPixelStorei(GL_UNPACK_ALIGNMENT, 1);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_REPEAT);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_REPEAT);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
	glTexEnvf(GL_TEXTURE_ENV, GL_TEXTURE_ENV_MODE, GL_REPLACE);
	glTexImage2D(GL_TEXTURE_2D, 0, 3, Tex_width, Tex_height, 0, GL_RGB, GL_UNSIGNED_BYTE, Texture1);
	glEnable(GL_TEXTURE_2D);
	LoadObjFile("horse1.obj");
	glDisable(GL_TEXTURE_2D);
	glEndList();
	glPopMatrix();
	
	//pillar2 & horse2 green
	pillar2 = glGenLists(2);
	glNewList(pillar2, GL_COMPILE);
	glPushMatrix();
	glColor3f(0.5f, 0.35f, 0.05f);
	GLUquadricObj* obj2 = gluNewQuadric();
	gluCylinder(obj2, 0.05f, 0.05f, r2, 36, 5);
	glEndList();
	glPopMatrix();
	glPushMatrix();
	horse2 = glGenLists(3);
	glNewList(horse2, GL_COMPILE);
	glTranslated(0, 0, 1.5f);
	glScaled(0.01f, 0.01f, 0.01f);
	unsigned char* Texture2;
	Texture2 = BmpToTexture("TW.bmp", &Tex_width, &Tex_height);
	glPixelStorei(GL_UNPACK_ALIGNMENT, 1);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_REPEAT);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_REPEAT);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
	glTexEnvf(GL_TEXTURE_ENV, GL_TEXTURE_ENV_MODE, GL_REPLACE);
	glTexImage2D(GL_TEXTURE_2D, 0, 3, Tex_width, Tex_height, 0, GL_RGB, GL_UNSIGNED_BYTE, Texture2);
	glEnable(GL_TEXTURE_2D);
	LoadObjFile("horse1.obj");
	glDisable(GL_TEXTURE_2D);
	glEndList();
	...
	//pillar3 & horse3 blue
	pillar3 = glGenLists(2);
	glNewList(pillar3, GL_COMPILE);
	glPushMatrix();
	glColor3f(0.5f, 0.35f, 0.05f);
	GLUquadricObj* obj3 = gluNewQuadric();
	gluCylinder(obj3, 0.05f, 0.05f, r2, 36, 5);
	glEndList();
	glPopMatrix();
	glPushMatrix();
	horse3 = glGenLists(3);
	glNewList(horse3, GL_COMPILE);
	glTranslated(0, 0, 1.5f);
	glScaled(0.01f, 0.01f, 0.01f);
	unsigned char* Texture3;
	Texture3 = BmpToTexture("zebra.bmp", &Tex_width, &Tex_height);
	glPixelStorei(GL_UNPACK_ALIGNMENT, 1);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_REPEAT);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_REPEAT);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
	glTexEnvf(GL_TEXTURE_ENV, GL_TEXTURE_ENV_MODE, GL_REPLACE);
	glTexImage2D(GL_TEXTURE_2D, 0, 3, Tex_width, Tex_height, 0, GL_RGB, GL_UNSIGNED_BYTE, Texture3);
	glEnable(GL_TEXTURE_2D);
	LoadObjFile("horse1.obj");
	glDisable(GL_TEXTURE_2D);
	glEndList();
	...
	//pillar4 & horse4 white
	pillar4 = glGenLists(2);
	glNewList(pillar4, GL_COMPILE);
	glPushMatrix();
	GLUquadricObj* obj4 = gluNewQuadric();
	gluCylinder(obj4, 0.05f, 0.05f, r2, 36, 5);
	glEndList();
	glPopMatrix();
	glPushMatrix();
	horse4 = glGenLists(3);
	glNewList(horse4, GL_COMPILE);
	glTranslated(0, 0, 1.5f);
	glColor3f(1.,1.,1.);
	glScaled(0.01f, 0.01f, 0.01f);
	unsigned char* Texture4;
	Texture4 = BmpToTexture("jjj.bmp", &Tex_width, &Tex_height);
	glPixelStorei(GL_UNPACK_ALIGNMENT, 1);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_REPEAT);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_REPEAT);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
	glTexEnvf(GL_TEXTURE_ENV, GL_TEXTURE_ENV_MODE, GL_REPLACE);
	glTexImage2D(GL_TEXTURE_2D, 0, 3, Tex_width, Tex_height, 0, GL_RGB, GL_UNSIGNED_BYTE, Texture4);
	glEnable(GL_TEXTURE_2D);
	LoadObjFile("horse1.obj");
	glDisable(GL_TEXTURE_2D);
	glEndList();
	...
	/*******the things not animating******/

	//draw the brown stick
	MidStick = glGenLists(2);
	glNewList(MidStick, GL_COMPILE);
	glPushMatrix();
	glColor3f(0.5f, 0.35f, 0.05f);
	GLUquadricObj* obj = gluNewQuadric();
	gluCylinder(obj, 0.5f, 0.5f, r2, 36, 5);
	glEndList();
	glPopMatrix();
	...
	glPushMatrix();
	RDown= glGenLists(2);
	glNewList(RDown, GL_COMPILE);
	glNormal3f(0., 0., 1.);
	glTranslatef(0., 0., r2);
	glBegin(GL_TRIANGLE_FAN);
	glColor3f(1., 0., 1.);
	for (int i = 0; i < 100; i++) {
		glVertex3f(R * cos(ang), R * sin(ang), 0.);
		ang += dang;
	}
	glEnd();
	glEndList();
	...
	//draw the yellow cylinder
	glPushMatrix();
	RMid = glGenLists(2);
	glNewList(RMid, GL_COMPILE);
	glColor3f(1., 1., 0.);
	glTranslatef(0., 0., r2);
	GLUquadricObj* objCylinder = gluNewQuadric();
	gluCylinder(objCylinder, 2.8f, 0.5f, 1.0f, 36, 5);
	glEndList();
	glPopMatrix();
	...
	glPushMatrix();
	RTop = glGenLists(2);
	glNewList(RTop, GL_COMPILE);
	glTranslatef(0., 0., r2+1.0f);
	glBegin(GL_TRIANGLE_FAN);
	glColor3f(0., 0., 1.);
	glNormal3f(0., 0., 1.);
	for (int i = 0; i < 100; i++) {
